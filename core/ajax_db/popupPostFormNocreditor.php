        ...
        <div class="img-popup-wrapLogin"  id="popupEnd">
            ...
            <div class="card borders-tops">
              ...
              <div class="card-body message-color">
                <form method="post" id="popupForm-noEditor" enctype="multipart/form-data">
                    ...
                    <div class="user-block">
                        ...
                        <div class="message-footer text-muted">
                            ...
                            <div class="t-fo-right">
                                ...
                                <input type="button" class="btn main-active"  id="submit-popupForm-noEditor" name="addpost" value="Post">
                            </div>
