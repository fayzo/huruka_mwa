                    ...
                    <!-- <script>
                        $('input[type="checkbox"]').on('change', function() {
                         ...
                         <div class="mailbox-controls">
                             ...
                             <div class="btn-group">
                                 <button type="button" class="btn btn-default btn-sm alldeleteSent" ><i
                         ...
                         <div class="table-responsive mailbox-messages">
                            <form id="form-delete-all-sent" method="post">
                             <table class="table table-hover table-striped">
                                 ...
                                 <tbody>
                                    <tr><span id="responseSubmitalldeleteSent"></span></tr>
                                    <tr><input type="hidden" name="deleteChecksent" value="deleteChecksent" ></tr>
