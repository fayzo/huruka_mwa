<div class="container mt-2">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-12 col-md-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item">Bible</li>
  ...
  <div id="Bible">
    ...
    <div class="card-footer text-muted text-center">
        ...
        <a type="button" href="https://www.bible.com/bible/" target="__blank"  class="text-primary">Read Bible >>> </a>

        <!-- Translation copyright 1996, 2004, 2007, 2015 by Tyndale House Foundation. Used by permission of Tyndale House Publishers, Inc., Carol Stream, Illinois, 60188. All rights reserved. -->
    </div>
  </div>
</div>
