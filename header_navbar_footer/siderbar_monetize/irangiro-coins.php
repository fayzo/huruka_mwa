    ...
    <section class="content-header">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1><i> irangiro-coins</i></h1>
            </div>

            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item">irangiro-coins</li>
                </ol>
            </div>
            ...
            <?php
                ...
                ?>
                            <tr>
                                ...
                                <td><?php echo 'irangiro subscription' ;?></td>
                                <td><?php echo number_format($row['irangiro_price_pay'])?></td>
                                <td><?php echo $home->timeAgo($row['irangiro_date_pay'])?></td>
                            </tr>
            <?php } ?>
