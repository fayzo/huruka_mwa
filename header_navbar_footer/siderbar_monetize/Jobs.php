...
<?php
    ...
    ?>
                <tr>
                    ...
                    <td><?php echo 'Job subscription' ;?></td>
                    <td><?php echo $row['job_subscription'] ;?></td>
                    <td><?php echo number_format($row['job_price_pay'])?></td>
                    <td><?php echo $home->timeAgo($row['job_date_pay'])?></td>
                </tr>
<?php } ?>
