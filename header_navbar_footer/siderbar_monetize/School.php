...
<?php
    ...
    ?>
                <tr>
                    ...
                    <td><?php echo 'school subscription' ;?></td>
                    <td><?php echo $row['school_subscription'] ;?></td>
                    <td><?php echo number_format($row['school_price_pay'])?></td>
                    <td><?php echo $home->timeAgo($row['school_date_pay'])?></td>
                </tr>
<?php } ?>
