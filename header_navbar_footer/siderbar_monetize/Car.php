...
<?php
    ...
    ?>
                <tr>
                    ...
                    <td><?php echo 'car subscription' ;?></td>
                    <td><?php echo $row['car_subscription'] ;?></td>
                    <td><?php echo number_format($row['car_price_pay'])?></td>
                    <td><?php echo $home->timeAgo($row['car_date_pay'])?></td>
                </tr>
<?php } ?>
