            ...
            <?php
                ...
                ?>
                            <tr>
                                ...
                                <td><?php echo 'marketplace subscription' ;?></td>
                                <td><?php echo number_format($row['marketplace_price_pay'])?></td>
                                <td><?php echo $home->timeAgo($row['marketplace_date_pay'])?></td>
                            </tr>
            <?php } ?>
