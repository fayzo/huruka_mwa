...
<?php
    ...
    ?>
                <tr>
                    ...
                    <td><?php echo 'house subscription' ;?></td>
                    <td><?php echo $row['house_subscription'] ;?></td>
                    <td><?php echo number_format($row['house_price_pay'])?></td>
                    <td><?php echo $home->timeAgo($row['house_date_pay'])?></td>
                </tr>
<?php } ?>
