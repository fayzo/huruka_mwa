            ...
            <style>
             ...
             <div class="card">
                <div class="card-header">
                   <a class="btn btn-success btn-sm  float-right" href="<?php echo BASE_URL_PUBLIC.'school' ;?>" >Back</a>
                        ...
                        <div class="mb-2">
                            ...
                            <div class="p-2">
                                <div class="input-group ">
                                    ...
                                    <input type="text" id="mycopyText" style="width:1px" class="form-control" value="<?php echo BASE_URL_PUBLIC."school_detail?id=".$_GET['id'];?>" readonly>
                                </div>
                                <!-- <a class="btn btn-sm btn-primary mt-2" href="< ?php echo BASE_URL_PUBLIC."school_detail?id=".$_GET['id'];?>"> Redirect to link</a> -->
