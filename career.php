            ...
            <div class="row mb-3" style="background:#fff">
                ...
                <div class="col-md-3-3 p-2">
                        ...
                        <div class="input-group ">
                            ...
                            <input type="text" id="mycopyText" style="width:1px" class="form-control" value="<?php echo BASE_URL_PUBLIC."career?id=".$_GET['id'] ;?>" readonly>
                        </div>
    
                        <!-- <a class="btn btn-sm btn-primary mt-2" href="< ?php echo BASE_URL_PUBLIC."career?id=".$_GET['id'] ;?>"> Redirect to link</a> -->
