        ...
        <div class="row flex-nowrap justify-content-between align-items-center">
            <div class="col-4">
                ...
                <?php 
                    ...
                    (!empty($subscription['car_subscription']) && $users->subscription_deadline($subscription['car_date_pay'],$subscription['car_subscription']) == true )?
                    'class="btn btn-light" id="add_car" data-car="'.$_SESSION['key'].'"':'class="btn btn-light price-post" data-pricejob="car"' 
      ...
      <section class="content container-fuild">
        ...
        <div class="card">
                <div class="card-header">
                   <a class="btn btn-success btn-sm  float-right" href="<?php echo BASE_URL_PUBLIC.'car' ;?>" >Back</a>
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <div class="p-2">
                                    <div class="input-group ">
                                        ...
                                        <input type="text" id="mycopyText" style="width:1px" class="form-control" value="<?php echo BASE_URL_PUBLIC."cars?id=".$_GET['id'];?>" readonly>
                                    </div>
                
                                    <!-- <a class="btn btn-sm btn-primary mt-2" href="< ?php echo BASE_URL_PUBLIC."cars?id=".$_GET['id'];?>"> Redirect to link</a> -->
                ...
                <?php 
                    ...
                    if ($count_image === 1) { ?>
                        ...
                        <div class="row mb-1">
                            ...
                            <div class="col-12 more">
                                <img style="width: 100%;height: auto;" class="imagecarViewPopupmore"  data-car="<?php echo $user["car_id"] ;?>"
                                    src="<?php echo BASE_URL_PUBLIC."uploads/car/".$expode[0] ;?>" >
                    ...
                    <?php
                        ...
                        <div class="row mb-2 more">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <img style="width: 100%;height: auto;" class="imagecarViewPopupmore"  data-car="<?php echo $user["car_id"] ;?>"
                                    src="<?php echo BASE_URL_PUBLIC."uploads/car/".$splice[$i] ;?>" >
                    ...
                    <?php }else if($count_image === 3 || $count_image > 3){?>
                        ...
                        <div class="col-6">
                            <img style="width: 100%;height: auto;" class="imagecarViewPopupmore"  data-car="<?php echo $user["car_id"] ;?>"
                                src="<?php echo BASE_URL_PUBLIC."uploads/car/".$splice[0] ;?>" >
