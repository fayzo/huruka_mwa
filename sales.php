      ...
      <section class="content container-fuild">
        ...
        #image-gallery li img {
            ...
            <div class="card-header">
                   <a class="btn btn-success btn-sm  float-right" href="<?php echo BASE_URL_PUBLIC.'sale' ;?>" >Back</a>
                   ...
                   <div class="user-block">
                        <div class="user-blockImgBorder">
                         ...
                         <span class="description">Shared publicly - <?php echo $users->timeAgo($user['created_on01']) ;?></span>
                     </div> <!-- /.user-block -->
                </div> <!-- /.card-header -->
                    ...
                    <div class="col-md-6 mb-2">
                            ...
                            <div class="p-2">
                                <div class="input-group ">
                                    ...
                                    <input type="text" id="mycopyText" style="width:1px" class="form-control" value="<?php echo BASE_URL_PUBLIC."sales?id=".$_GET['id'];?>" readonly>
                                </div>
            
                                <!-- <a class="btn btn-sm btn-primary mt-2" href="< ?php echo BASE_URL_PUBLIC."sales?id=".$_GET['id'];?>"> Redirect to link</a> -->
