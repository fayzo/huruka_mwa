                    ...
                    <div class="card-body">
                       ...
                       <ul class="ads-nav list-unstyled">
                           <li>
                               ...
                               Subscribe <br>
                               <!-- From May 21 To May 04 -->
                               <?php 
                               if (!empty($subscription['campain_subscription'])) {
                                   # code...
                                    $date = $subscription['campain_date_pay'];
                                    $month = $subscription['campain_subscription'];
                           ...
                           <li>
                               ...
                               echo (isset($_SESSION['key']))?
                                (!empty($subscription['campain_subscription'])  && $users->subscription_deadline($subscription['campain_date_pay'],$subscription['campain_subscription']) == true )?
                                'class="promote_forms " ' :
