                               ...
                               <?php if(!empty($retweet['retweet_Msg']) && $tweet["tweet_id"] == $retweet["retweet_id"] || $tweet["retweet_id"] > 0){ ?> 
                                ...
                                <?php if(array_diff($fileActualExt,$image)) { ?>
                                    ...
                                    <?php }else if(array_diff($fileActualExt,$pdf)) { ?>
                                            ...
                                            <?php }else if(array_diff($fileActualExt,$allower_ext)[0] == 'ins'){ ?>
                                                <div class="row">
                                                    <div class="col-6 ">
                                            ...
                                            <?php }else if(array_diff($fileActualExt,$allower_ext)[0] == 'ard'){ ?>
                                                <div class="row">
                                                    <div class="col-6 ">
                                                        <?php $username =(!empty($_SESSION['username']))? $_SESSION['username']: 'irangiro' ;?> 
                                                        <?php echo Follow::coins_recharge_tweet($tweet['user_id'],$user_id,$username,$tweet['username'],$tweet["tweet_id"]); ?>
                                ...
                                $fileActualExt_card =array_intersect($fileActualExt,$card);
                                // var_dump(is_array($fileActualExt_image));
