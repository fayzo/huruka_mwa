                    ...
                    <span id="responseSubmitdelete"></span>
                     <div class="card-body p-0">
                         ...
                         <div class="mailbox-controls with-border text-center">
                             <div class="btn-group">
                                 <button type="button" class="btn btn-default btn-sm deleteformSent" data-delete="deleteSent"  data-cvid="<?php echo $row['cv_id']; ?>" data-id_radom="<?php echo $row['cv_id_radom']; ?>" data-toggle="tooltip"
...
if (isset($_POST['deleteSent'])) {
    ...
    if ($_POST['deleteSent'] == 'deleteSent') {
	    ...
	    // $job->SentDelete('email_apply_job',$id,$id_radom,$datetime);
