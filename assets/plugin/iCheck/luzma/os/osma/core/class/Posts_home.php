                ...
                <div class="col-12 mb-3">
                    ...
                    <div class="card borders-bottoms more" >
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-muted mt-2 clear-float"><?php echo $row['categories_fundraising']; ?>
          ...
          <ul class="mt-2 list-inline" style="list-style-type: none; margin-bottom:10px;">  
                    ...
                    <?php }else{ ?>
                           ...
                           <li  class=" list-inline-item"> <button <?php echo (isset($_SESSION['key']))?'class="share-btn retweet text-sm mr-2"':'class=" text-sm mr-2" id="login-please" data-login="1"' ;?>   data-tweet="<?php echo $tweet['tweet_id']; ?>"  data-user="<?php echo $tweet['tweetBy']; ?>">
                            <?php if($retweet["retweet_counts"] > 0){ echo '<i class="fa fa-share mr-1" style="color: green"> <span class="retweetcounter">'.$this->nice_number($retweet["retweet_counts"]).'</span></i>' ; }else{ echo '<i class="fa fa-share mr-1"> <span class="retweetcounter">'.''.'</span></i>';} ?>
                               Share</button></li>
