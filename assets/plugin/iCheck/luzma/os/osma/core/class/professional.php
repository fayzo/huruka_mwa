    ...
    public function emplyomentfetchALL($categories,$pages)
    {
        ...
        <div class="card-header main-active p-1">
            <h5 class="card-title float-left pl-2"><i> Search Any Fields  </i></h5>
             <div class="dropdown float-right " style="clear:right;height:2rem;float:right;">
                  ...
                  <div class="dropdown-menu large-2" aria-labelledby="triggerId" style="left: -155px;">
                    ...
                    <a class="dropdown-item d-flex justify-content-between align-items-center" href="javascript:void(0)" onclick="employmentCategories('Tourism',1);" >Tourism<span class="badge badge-primary"><?php echo $this->emplyomentcountPOSTS('Tourism');?></span></a>
                    <a class="dropdown-item d-flex justify-content-between align-items-center" href="javascript:void(0)" onclick="employmentCategories('Hospitality',1);" >Hospitality<span class="badge badge-primary"><?php echo $this->emplyomentcountPOSTS('Hospitality');?></span></a>
                    ...
                    <a class="dropdown-item d-flex justify-content-between align-items-center" href="javascript:void(0)" onclick="employmentCategories('Construction',1);" >Construction<span class="badge badge-primary"><?php echo $this->emplyomentcountPOSTS('Construction');?></span></a>
            ...
            <div class="nav-scroller py-0" style="clear:both;height:3.4rem;"> 
                ...
                <a class="p-2" href="javascript:void(0)" onclick="employmentCategories('Tourism',1);" >Tourism<span class="badge badge-primary"><?php echo $this->emplyomentcountPOSTS('Tourism');?></span></a>
                <a class="p-2" href="javascript:void(0)" onclick="employmentCategories('Hospitality',1);" >Hospitality<span class="badge badge-primary"><?php echo $this->emplyomentcountPOSTS('Hospitality');?></span></a>
                ...
                <a class="p-2" href="javascript:void(0)" onclick="employmentCategories('Construction',1);" >Construction<span class="badge badge-primary"><?php echo $this->emplyomentcountPOSTS('Construction');?></span></a>
