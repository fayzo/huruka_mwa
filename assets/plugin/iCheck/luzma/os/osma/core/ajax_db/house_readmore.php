                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <div class="p-2">
                                <div class="input-group ">
                                    ...
                                    <input type="text" id="mycopyText" style="width:1px" class="form-control" value="<?php echo BASE_URL_PUBLIC."houses?id=".$_POST['house_id'];?>" readonly>
                                </div>
            
                                <a class="btn btn-sm btn-primary mt-2" href="<?php echo BASE_URL_PUBLIC."houses?id=".$_POST['house_id'];?>"> Redirect to link</a>
