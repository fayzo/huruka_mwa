        ...
        <div class="img-popup-wrap"  id="popupEnd">
        	<div class="img-popup-body">
                ...
                <div class="card-deck mb-3 text-center">
                        ...
                        <div class="card-body">
                            <?php $details= '\''.$user['firstname'].'\',\''.$user['lastname'].'\',\''.$user['email'].'\','.$user['user_id'].',\'newsfeed\'' ;?>
                            <h3 class="card-title pricing-card-title">$10 <small class="text-muted">/ we</small></h3>
                            <ul class="list-unstyled mt-3 mb-4">
                              <li>10 Post last 2 week</li>
                        ...
                        <div class="card-body">
                            <h3 class="card-title pricing-card-title">$200 <small class="text-muted">/ mo</small></h3>
                            <ul class="list-unstyled mt-3 mb-4">
                                <li>Unlimited posts</li>
                                <li>Reach 50,000 people</li>
                                <li>Help center access</li>
                            </ul>
                            <button type="button" class="btn btn-lg btn-block btn-primary" onclick="coins_recharge(200000,'months',<?php echo $details ;?>)">Get started</button>
                        </div>
                        </div>
                    </div>
