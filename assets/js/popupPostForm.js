$(document).ready(function () {
    ...
    $(document).on('click', "#submit-popupForm", function (e) {
...
// NO CKEDITOR EDITOR PAGE FOR POST MESSAGE 
// NO CKEDITOR EDITOR PAGE FOR POST MESSAGE 

    $(document).on('click', '.addPostBtnNocreditor', function () {
        ...
        $.ajax({
            url: 'core/ajax_db/popupPostFormNocreditor',
            method: 'POST',
            dataType: 'text',
            data: {
            }, success: function (response) {
    ...
    $(document).on('click', "#submit-popupForm-noEditor", function (e) {
        ...
        // }
         // e.preventDefault();
         e.stopPropagation();
         var formdatas = $('#popupForm-noEditor');
