$(document).ready(function () {
    ...
    $(document).on('click', '.newsfeeds_forms', function () {

        $.ajax({
            url: 'core/ajax_db/message_newsfeed_forms',
            method: 'POST',
            dataType: 'text',
            data: {
    ...
    $(document).on('submit', "#newsfeedsForm", function (e) {
        ...
        var textarea = CKEDITOR.instances.editor1.getData();
         ...
         if (image_name == '') {
            ...
            if (textarea != '') {
                $.ajax({
                    url: "core/ajax_db/message_newsfeed_post",
                    method: "POST",
                    data: {
                        key: 'textarea',
                        id: id,
