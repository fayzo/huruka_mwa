...
<?php include "header_navbar_footer/header.php"?>
    ...
    <header class="blog-header py-2 mb-3 bg-light">
      ...
      <section class="content container-fuild">
        ...
        <?php   if (isset($_GET['crowfund_id']) && !empty($_GET['crowfund_id'])) {
    ...
    ?>
           <div class="card">
                <div class="card-header">
                    <a class="btn btn-success btn-sm  float-right" href="<?php echo BASE_URL_PUBLIC.'crowfund' ;?>" >Back</a>
