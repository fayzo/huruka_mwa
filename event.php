    ...
    <header class="blog-header py-2 mb-3 bg-light">
        ...
        <div class="row flex-nowrap justify-content-between align-items-center">
          ...
          <div class="col-4 text-center">
            <a class="blog-header-logo text-dark" href="#">Event</a>
          </div>
          ...
          .event_two_blocks div span {display:block;font-weight:500;text-transform:capitalize;margin-bottom:2px;font-size:16px}
            ...
            <div class="card">
                <div class="card-header">
                    <a class="btn btn-success btn-sm  float-right" href="<?php echo BASE_URL_PUBLIC.'events' ;?>" >Back</a>
                     ...
                     <div class="col-md-6">
                            ...
                            <div class="p-2">
                              <div class="input-group ">
                                  ...
                                  <input type="text" id="mycopyText" style="width:1px" class="form-control" value="<?php echo BASE_URL_PUBLIC."events?id=".$_GET['id'];?>" readonly>
                              </div>
          
                              <!-- <a class="btn btn-sm btn-primary mt-2" href="< ?php echo BASE_URL_PUBLIC."events?id=".$_GET['id'];?>"> Redirect to link</a> -->
                            ...
                            <h5 class="mt-3"> Comments</h5>
                                ...
                                <div class="input-group mt-2">
                                    <input class="form-control form-control-sm" id="commentField" type="text"
                                        name="comment" data-events="<?php echo $user['id'];?>"
